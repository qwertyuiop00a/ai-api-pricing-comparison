...
It is the observed 1K unit price on the `gpt-image-2.5-ext` route at the time of writing (2026-09-16), read back from the completed task's own `cost` field. Prices change; the [pricing page](https://apimart.ai/pricing) is the authority.
